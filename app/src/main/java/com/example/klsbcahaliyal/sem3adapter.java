...
public class sem3adapter extends FirebaseRecyclerAdapter<sem3model,sem3adapter.myviewholder>
{

    public sem3adapter(@NonNull  FirebaseRecyclerOptions<sem3model> options3)
    {
        super(options3);
    }

    @Override
    protected void onBindViewHolder(@NonNull sem3adapter.myviewholder holder, int position, @NonNull  sem3model model) {
