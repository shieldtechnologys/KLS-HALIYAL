...
public class sem2adapter extends FirebaseRecyclerAdapter<sem2model,sem2adapter.myviewholder>
{

    public sem2adapter(@NonNull  FirebaseRecyclerOptions<sem2model> options2)
    {
        super(options2);
    }

    @Override
    protected void onBindViewHolder(@NonNull sem2adapter.myviewholder holder, int position, @NonNull  sem2model model) {
