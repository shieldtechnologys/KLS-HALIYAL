...
public class myadapterevent extends FirebaseRecyclerAdapter<eventmodel,myadapterevent.myviewholder1>
{

    public myadapterevent(@NonNull  FirebaseRecyclerOptions<eventmodel> options) {

        super(options);
    }

    @Override
    protected void onBindViewHolder(@NonNull  myadapterevent.myviewholder1 holder, int position, @NonNull eventmodel model) {
